...
import { Button, Card, Col, List, Progress, Row, Typography, Upload, UploadFile } from 'antd';
import {
  Form,
} from 'antd';
...
const App: React.FC = () => {
  ...
  const [files, setFiles] = useState([
    { fileName: "大文件X", percent: 1.23, status: 'stop' }
  ])
      ...
      <Row gutter={24}>
        ...
        <Col span={12}>
          <List
            ...
            renderItem={(item) => (
              <List.Item>
                <Progress percent={Number(item.percent.toFixed(2))} /><Button>暂停</Button>
              </List.Item>
            )}
          />
        </Col>
